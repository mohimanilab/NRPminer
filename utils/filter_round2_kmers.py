...
def filter_intensity_kmerScore(
	...
	if highetScoredKmer[1]>=3 and percentProteinoPeaks>0.6:
		...
		if percentProteinoPeaks <0.7 and percentPolymerPeaks>0.35:
                        final_compound="polymer"
	return final_compound, highetScoredKmer[1],percentPolymerPeaks,percentProteinoPeaks, all_kmerScores, all_kmerFrequencies , all_kmerSequences, all_kmerMatches,building_blocks
